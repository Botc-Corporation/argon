      ...
      <div class="card shadow">
         <div class="card-header border-0">
            <div class="row align-items-center">
               <div class="col">
                  <h3 class="mb-0">Liste de vos Serveurs</h3>
               </div>
               <div class="col text-right">
                  <a href="https://neptune-heberg.fr" class="btn btn-sm btn-primary">Site Web</a>
               </div>
            </div>
         </div>
            ...
            <table class="table align-items-center table-flush">
               <thead class="thead-light">
                  <tr>
                     ...
                     <th scope="col" class="d-none d-lg-table-cell">RAM</th>
                     <th scope="col" class="d-none d-lg-table-cell">CPU</th>
                     <th scope="col" class="d-none d-lg-table-cell">Espace Disque</th>
