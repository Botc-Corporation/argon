              ...
              <div class="form-group">
                 ...
                 <div class="mb-1">
                   <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" id="public_1" value="1" name="public" {{ (old('public', $node->public)) ? 'checked' : '' }}>
                      <label class="custom-control-label" for="public_1">Yes</label>
                   </div>
                   <div class="custom-control custom-radio" style="padding-left: 2.75rem;">
                      <input class="custom-control-input" type="radio"  id="public_0" value="0" name="public" {{ (old('public', $node->public)) ? '' : 'checked' }}>
