    ...
    <div class="col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
        <div class="card">
            <div class="card-body text-center">
                <h1 class="text-warning" style="font-size: 160px !important;font-weight: 100 !important;">Backup Create In Progress</h1>
                <p class="text-muted">Backup create in progress! Please wait...</p>
            </div>
